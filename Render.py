...
class Renderer(object):
    ...
    def rotarObjPitch(self, alpha):
        self.cambioPitch = alpha

    def rotarObjYaw(self, beta):
        self.cambioYaw = beta

    def rotarObjRoll(self, omega):
        self.cambioRoll = omega
    ...
    def render(self):
        ...
        translate = glm.translate(i, glm.vec3(0, 0, 3))
        ...
        # Camara
        camTranslate = glm.translate(i, self.cubePos)
        camPitch = glm.rotate(i, glm.radians(self.cambioPitch), glm.vec3(1, 0, 0))
        camYaw = glm.rotate(i, glm.radians(self.cambioYaw), glm.vec3(0, 1, 0))
        camRoll = glm.rotate(i, glm.radians(self.cambioRoll), glm.vec3(0, 0, 1))
